...
//		args [1] = "../StackerPrograms/program/Calc2.stk";
	...
	private static void run(String source) {
		try {
			...
			interpreter.ambiente.put("a", "0");
			interpreter.ambiente.put("b", "1");
			interpreter.ambiente.put("c", "2");
			interpreter.ambiente.put("d", "3");
			interpreter.ambiente.put("e", "4");
			interpreter.ambiente.put("f", "5");
			interpreter.ambiente.put("g", "6");
			interpreter.ambiente.put("h", "7");
			interpreter.ambiente.put("i", "8");
			interpreter.ambiente.put("j", "9");
